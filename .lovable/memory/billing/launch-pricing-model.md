...
description: Foreman 3-tier launch pricing — Solo €29, Crew €49, Business €99, +€19/extra seat, 2.9% platform fee
type: feature
---
Foreman uses a 3-tier subscription model (Apr 2026 launch). Source of truth: `src/hooks/useSubscriptionTier.ts` (`PRICING` const + `ALL_TIERS`).
...
- **Platform fee:** 2.9% application fee on Stripe Connect payments (Foreman's marketplace revenue).
