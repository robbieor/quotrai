      ...
      <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", fontFamily, WebkitFontSmoothing: "antialiased" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ marginTop: 48, transform: `scale(${logoScale})`, display: "inline-flex", alignItems: "center", gap: 16 }}>
            <Img src={staticFile("images/quotr-logo.png")} style={{ width: 68, height: 68, borderRadius: 16, filter: "drop-shadow(0 0 30px rgba(0,255,178,0.4))" }} />
            <span style={{ fontSize: 44, fontWeight: 800, color: "white", letterSpacing: "-0.04em", textShadow: "0 2px 20px rgba(0,0,0,0.3)" }}>Quotr</span>
          </div>
