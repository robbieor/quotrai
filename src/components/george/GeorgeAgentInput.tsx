    ...
    <div className="border-t border-border bg-background p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative flex items-end gap-2 bg-muted rounded-2xl p-2">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="icon"
                  className={`shrink-0 rounded-full ${!isConnected && !showVoiceLock ? "bg-primary hover:bg-primary text-primary" : ""}`}
          ...
          <Button
            size="icon"
            className="shrink-0 rounded-full bg-primary hover:bg-primary text-primary"
