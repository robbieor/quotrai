      ...
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-10 sm:mb-14 animate-fade-up">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            You didn't start a trade business to do admin. Foreman takes it off your plate.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 animate-fade-up" style={{ animationDelay: "100ms" }}>
          ...
          <div className="rounded-2xl border border-destructive/20 bg-destructive/5 p-6 sm:p-8">
            <h3 className="text-lg sm:text-xl font-bold text-destructive mb-5">Without Foreman</h3>
          ...
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 sm:p-8">
            <h3 className="text-lg sm:text-xl font-bold text-primary mb-5">With Foreman</h3>
            <ul className="space-y-4">
              {afterItems.map((item) => (
                <li key={item} className="flex items-start gap-3">
