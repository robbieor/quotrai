      ...
      <SidebarProvider>
        <div className={cn(
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <TrialBanner />
            <header className="h-12 md:h-14 border-b border-border text-foreground items-center justify-start flex flex-row px-3 md:px-6 py-[10px] bg-card sticky top-0 z-20">
