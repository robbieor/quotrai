...
const KEY_WORKFLOWS = [
  ...
  { icon: CreditCard, title: "Stripe Connect Payments", desc: "Customers pay online via branded portal. 2.9% platform fee on every transaction. Passive revenue.", tag: "Revenue" },
