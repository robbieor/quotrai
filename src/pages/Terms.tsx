      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-foreground/90">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
               New accounts receive a 7-day free trial with full access to platform features. At the end of the trial, you must select a paid plan to continue using the Service.
            </p>
          </section>
