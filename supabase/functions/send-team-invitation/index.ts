        ...
        <div style="max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #fff; padding: 30px; border: 1px solid #e2e8f0; border-top: none;">
            ...
            <div style="text-align: center;">
              <a href="${inviteUrl}" style="display: inline-block; background: linear-gradient(135deg, #00FFB2, #00D4FF); color: #0f172a; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 20px 0;">Accept Invitation</a>
            </div>
